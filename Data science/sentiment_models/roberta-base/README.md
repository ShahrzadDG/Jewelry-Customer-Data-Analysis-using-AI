...
Although RoBERTa slightly improved macro F1-score and neutral-class recall, the gain was modest compared with DistilBERT. Given the higher computational cost of RoBERTa, DistilBERT remains the more practical choice for efficient deployment, while RoBERTa may be preferred only when improved neutral-class detection is a priority.
