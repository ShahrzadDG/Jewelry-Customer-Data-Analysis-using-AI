...
1. Identifying Jewelry Products:
      ...
      Method:
         ...
         i. Metadata filtering (select only jewelry items)
      
         ii. Providing jewelry product list (store their unique parent_asin identifiers) 
...
2. Extracting Reviews for Jewelry Products:
      ...
      Method:
         ...
         i.Review filtering (keep only jewelry reviews)
      
         ii.Structured parquet dataset partitioned by year/month
